  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-2 px-3 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-all hover:scale-105 shadow-lg"
      ...
      {isOpen && (
        <>
          ...
          {/* Menu */}
          <div className="absolute top-full mt-2 right-0 bg-gray-900 border border-gray-700 rounded-lg shadow-2xl z-50 min-w-[280px] animate-fadeIn">
            <div className="p-3 border-b border-gray-700 flex items-center justify-between">
              <p className="text-xs text-gray-400 font-medium">📥 Legal Downloads Only</p>
              <button 
                onClick={(e) => {
                  e.stopPropagation();
                  setIsOpen(false);
