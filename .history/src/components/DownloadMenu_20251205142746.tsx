          ...
          <div className="absolute bottom-full mb-2 right-0 bg-gray-900 border border-gray-700 rounded-lg shadow-2xl z-[101] min-w-[280px] max-w-[320px]">
            ...
            <div className="p-2 space-y-1">
              ...
              <button
                ...
                className="w-full flex items-center gap-3 px-3 py-2 text-left text-sm text-gray-200 hover:bg-gray-800 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <FileJson size={16} className="text-blue-400 flex-shrink-0" />
                <div className="flex-1 min-w-0">
                  <p className="font-medium text-xs">Metadata</p>
                </div>
                {downloading === 'metadata' && (
                  <div className="animate-spin rounded-full h-3 w-3 border-2 border-gray-500 border-t-white flex-shrink-0"></div>
                )}
              </button>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="font-medium text-xs">Poster</p>
                </div>
                {downloading === 'poster' && (
                  <div className="animate-spin rounded-full h-3 w-3 border-2 border-gray-500 border-t-white flex-shrink-0"></div>
                )}
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="font-medium text-xs">Info Page</p>
                </div>
                {downloading === 'info' && (
                  <div className="animate-spin rounded-full h-3 w-3 border-2 border-gray-500 border-t-white flex-shrink-0"></div>
                )}
              ...
              <button
                ...
                className="w-full flex items-center gap-3 px-3 py-2 text-left text-sm text-gray-200 hover:bg-gray-800 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <BookmarkPlus size={16} className="text-yellow-400 flex-shrink-0" />
                <div className="flex-1 min-w-0">
                  <p className="font-medium text-xs">Watchlist</p>
                </div>
