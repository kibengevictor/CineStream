...
export default function Sidebar() {
    ...
    return (
        <aside className={`fixed left-0 top-0 h-screen ${isCollapsed ? 'w-20' : 'w-64'} bg-[#1c1c1e] text-white flex flex-col border-r border-white/10 transition-all duration-300`}>
            {/* Logo/Brand */}
            ...
            <button
                ...
                className="absolute -right-3 top-8 bg-[#2c2c2e] hover:bg-[#3a3a3c] text-white rounded-full p-1 border border-white/10 transition-colors z-50"
            >
