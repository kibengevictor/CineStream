            ...
            <div className="relative aspect-[2/3] bg-[#2c2c2e] rounded-2xl overflow-hidden shadow-xl">
                ...
                <div className="absolute top-3 right-3 z-20">
                    <button 
                        ...
                        className="bg-black/50 hover:bg-black/70 text-white rounded-full p-2 opacity-0 group-hover:opacity-100 transition-all duration-300 backdrop-blur-sm relative z-10"
                    >
