    ...
    return (
        <div className="group cursor-pointer movie-card animate-fadeIn flex-shrink-0 w-[180px]">
            <div className="relative aspect-[2/3] bg-[#2c2c2e] rounded-2xl overflow-hidden shadow-xl">
                ...
                <div className="absolute top-3 right-3 z-20">
                    <button 
                        ...
                        className="bg-black/70 hover:bg-black/90 text-white rounded-full p-2 opacity-100 transition-all duration-300 backdrop-blur-sm relative z-10"
                    >
                    ...
                    {/* Dropdown Menu */}
                    {showMenu && (
                        <div className="absolute right-0 mt-2 w-48 bg-[#2c2c2e] rounded-lg shadow-xl border border-white/10 py-2 z-50">
                            <button
                                onClick={toggleFavorite}
                                className="w-full px-4 py-2 text-left text-sm text-white hover:bg-[#3a3a3c] flex items-center space-x-2"
                            >
                            ...
                            <button
                                ...
                                className="w-full px-4 py-2 text-left text-sm text-white hover:bg-[#3a3a3c] flex items-center space-x-2"
                            >
                                <Bookmark className={`w-4 h-4 ${isInWatchlist ? 'fill-blue-500 text-blue-500' : ''}`} />
            ...
            <div className="mt-3">
                ...
                {/* More button with dropdown - moved below title */}
                <div className="relative mt-2">
                    ...
                    {/* Dropdown Menu */}
                    {showMenu && (
                        <div className="absolute left-0 mt-2 w-48 bg-[#2c2c2e] rounded-lg shadow-xl border border-white/10 py-2 z-50">
                            <button
                                onClick={toggleFavorite}
                                className="w-full px-4 py-2 text-left text-sm text-white hover:bg-[#3a3a3c] flex items-center space-x-2"
                            >
